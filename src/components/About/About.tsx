                    ...
                    <div className='flex flex-col sm:flex-row mt-10'>
                        ...
                        <div className='sm:w-2/3 sm:pl-8 sm:py-8 sm:border-l border-gray-200 sm:border-t-0 border-t mt-4 pt-4 sm:mt-0 text-center sm:text-left'>
                            <p className='leading-relaxed text-lg mb-2'>
                                ...
                                Software Entwickler based in Hamburg - Germany.
                                Ich entwickle Web Applicationen und benutze
                                meist den MERN Stack, meine vorliebe liegt in
                                der React/Next.js - CRM mit GrarphQL gestützten
                            ...
                            <p className='leading-relaxed text-lg mb-2'>
                                ...
                                bereich coden sowie hardware. Ich Unterrichte
                                gern auch Kinder in der Web-Entwicklung um
                                Begeisterung so wie Talente zu finden und hier
                                Potenzail aufzugeigen.
                            </p>
                            <br />
                            <p className='leading-relaxed text-lg mb-2'>
                                Um euch meine Potenzial aufzuzeigen hab ich
                                diese Perönliche Protfoilio mit Next.js Tailwind
                                und GraphCRM erstell. Hier finde ihr all meine
                                Projeckte die Online sind und den Code auf
                                Github. ein Blog gibt es auch hier werde ich
                                versiedene Artickel Posten zum thema IT /
                            ...
                            <p className='leading-relaxed text-lg mb-2'>
                                ...
                                Posten zum Thema IT / Webentwicklung sowie Day -
                                in - Life eines Webentwicklers.
                            </p>
                            <Link href='/#blog'>
                                <a className='text-indigo-500 font-bold inline-flex items-center mb-4 hover:text-indigo-900'>
                                    Blog Highlights
